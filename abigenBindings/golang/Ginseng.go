...
func (_Smc *SmcTransactor) Mint(opts *bind.TransactOpts, to common.Address) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "mint", to)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address to) returns()
func (_Smc *SmcSession) Mint(to common.Address) (*types.Transaction, error) {
	return _Smc.Contract.Mint(&_Smc.TransactOpts, to)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address to) returns()
func (_Smc *SmcTransactorSession) Mint(to common.Address) (*types.Transaction, error) {
	return _Smc.Contract.Mint(&_Smc.TransactOpts, to)
}
