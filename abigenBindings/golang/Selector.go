...
func (_Smc *SmcCaller) CalcStoreInterfaceId(opts *bind.CallOpts) ([4]byte, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "calcStoreInterfaceId")
...
//
// Solidity: function calcStoreInterfaceId() pure returns(bytes4)
func (_Smc *SmcSession) CalcStoreInterfaceId() ([4]byte, error) {
	return _Smc.Contract.CalcStoreInterfaceId(&_Smc.CallOpts)
}

// CalcStoreInterfaceId is a free data retrieval call binding the contract method 0x63d5af8d.
//
// Solidity: function calcStoreInterfaceId() pure returns(bytes4)
func (_Smc *SmcCallerSession) CalcStoreInterfaceId() ([4]byte, error) {
	return _Smc.Contract.CalcStoreInterfaceId(&_Smc.CallOpts)
}
