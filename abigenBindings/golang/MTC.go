...
func (_Smc *SmcCaller) KFIVE2MTC(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "KFIVE2MTC")
...
//
// Solidity: function KFIVE2MTC() view returns(uint256)
func (_Smc *SmcSession) KFIVE2MTC() (*big.Int, error) {
	return _Smc.Contract.KFIVE2MTC(&_Smc.CallOpts)
}

// KFIVE2MTC is a free data retrieval call binding the contract method 0x62e8db23.
//
// Solidity: function KFIVE2MTC() view returns(uint256)
func (_Smc *SmcCallerSession) KFIVE2MTC() (*big.Int, error) {
	return _Smc.Contract.KFIVE2MTC(&_Smc.CallOpts)
}
...
func (_Smc *SmcCaller) KfiveToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "kfiveToken")
...
//
// Solidity: function kfiveToken() view returns(address)
func (_Smc *SmcSession) KfiveToken() (common.Address, error) {
	return _Smc.Contract.KfiveToken(&_Smc.CallOpts)
}

// KfiveToken is a free data retrieval call binding the contract method 0xe1c558c1.
//
// Solidity: function kfiveToken() view returns(address)
func (_Smc *SmcCallerSession) KfiveToken() (common.Address, error) {
	return _Smc.Contract.KfiveToken(&_Smc.CallOpts)
}
...
func (_Smc *SmcTransactor) ExchangeFromKfive(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "exchangeFromKfive", _value)
}

// ExchangeFromKfive is a paid mutator transaction binding the contract method 0x29fb503b.
//
// Solidity: function exchangeFromKfive(uint256 _value) returns()
func (_Smc *SmcSession) ExchangeFromKfive(_value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.ExchangeFromKfive(&_Smc.TransactOpts, _value)
}

// ExchangeFromKfive is a paid mutator transaction binding the contract method 0x29fb503b.
//
// Solidity: function exchangeFromKfive(uint256 _value) returns()
func (_Smc *SmcTransactorSession) ExchangeFromKfive(_value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.ExchangeFromKfive(&_Smc.TransactOpts, _value)
}
...
func (_Smc *SmcTransactor) Issue(opts *bind.TransactOpts, issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "issue", issuer, value)
}

// Issue is a paid mutator transaction binding the contract method 0x867904b4.
//
// Solidity: function issue(address issuer, uint256 value) returns()
func (_Smc *SmcSession) Issue(issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Issue(&_Smc.TransactOpts, issuer, value)
}

// Issue is a paid mutator transaction binding the contract method 0x867904b4.
//
// Solidity: function issue(address issuer, uint256 value) returns()
func (_Smc *SmcTransactorSession) Issue(issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Issue(&_Smc.TransactOpts, issuer, value)
}
...
func (_Smc *SmcTransactor) IssueByAdmin(opts *bind.TransactOpts, issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "issueByAdmin", issuer, value)
}

// IssueByAdmin is a paid mutator transaction binding the contract method 0xfae2b447.
//
// Solidity: function issueByAdmin(address issuer, uint256 value) returns()
func (_Smc *SmcSession) IssueByAdmin(issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.IssueByAdmin(&_Smc.TransactOpts, issuer, value)
}

// IssueByAdmin is a paid mutator transaction binding the contract method 0xfae2b447.
//
// Solidity: function issueByAdmin(address issuer, uint256 value) returns()
func (_Smc *SmcTransactorSession) IssueByAdmin(issuer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.IssueByAdmin(&_Smc.TransactOpts, issuer, value)
}
...
func (_Smc *SmcTransactor) Redeem(opts *bind.TransactOpts, redeemer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "redeem", redeemer, value)
}

// Redeem is a paid mutator transaction binding the contract method 0x1e9a6950.
//
// Solidity: function redeem(address redeemer, uint256 value) returns()
func (_Smc *SmcSession) Redeem(redeemer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Redeem(&_Smc.TransactOpts, redeemer, value)
}

// Redeem is a paid mutator transaction binding the contract method 0x1e9a6950.
//
// Solidity: function redeem(address redeemer, uint256 value) returns()
func (_Smc *SmcTransactorSession) Redeem(redeemer common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Redeem(&_Smc.TransactOpts, redeemer, value)
}
...
func (_Smc *SmcTransactor) TransferByAdmin(opts *bind.TransactOpts, from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "transferByAdmin", from, to, value)
}

// TransferByAdmin is a paid mutator transaction binding the contract method 0x8eb17dfe.
//
// Solidity: function transferByAdmin(address from, address to, uint256 value) returns()
func (_Smc *SmcSession) TransferByAdmin(from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.TransferByAdmin(&_Smc.TransactOpts, from, to, value)
}

// TransferByAdmin is a paid mutator transaction binding the contract method 0x8eb17dfe.
//
// Solidity: function transferByAdmin(address from, address to, uint256 value) returns()
func (_Smc *SmcTransactorSession) TransferByAdmin(from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.TransferByAdmin(&_Smc.TransactOpts, from, to, value)
}
...
func (_Smc *SmcTransactor) TransferKfiveReceiver(opts *bind.TransactOpts, newReceiver common.Address) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "transferKfiveReceiver", newReceiver)
}

// TransferKfiveReceiver is a paid mutator transaction binding the contract method 0x33738f96.
//
// Solidity: function transferKfiveReceiver(address newReceiver) returns()
func (_Smc *SmcSession) TransferKfiveReceiver(newReceiver common.Address) (*types.Transaction, error) {
	return _Smc.Contract.TransferKfiveReceiver(&_Smc.TransactOpts, newReceiver)
}

// TransferKfiveReceiver is a paid mutator transaction binding the contract method 0x33738f96.
//
// Solidity: function transferKfiveReceiver(address newReceiver) returns()
func (_Smc *SmcTransactorSession) TransferKfiveReceiver(newReceiver common.Address) (*types.Transaction, error) {
	return _Smc.Contract.TransferKfiveReceiver(&_Smc.TransactOpts, newReceiver)
}
...
func (_Smc *SmcTransactor) UpdateKfiveAddress(opts *bind.TransactOpts, newAddress common.Address) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "updateKfiveAddress", newAddress)
}

// UpdateKfiveAddress is a paid mutator transaction binding the contract method 0x1ff171c6.
//
// Solidity: function updateKfiveAddress(address newAddress) returns()
func (_Smc *SmcSession) UpdateKfiveAddress(newAddress common.Address) (*types.Transaction, error) {
	return _Smc.Contract.UpdateKfiveAddress(&_Smc.TransactOpts, newAddress)
}

// UpdateKfiveAddress is a paid mutator transaction binding the contract method 0x1ff171c6.
//
// Solidity: function updateKfiveAddress(address newAddress) returns()
func (_Smc *SmcTransactorSession) UpdateKfiveAddress(newAddress common.Address) (*types.Transaction, error) {
	return _Smc.Contract.UpdateKfiveAddress(&_Smc.TransactOpts, newAddress)
}
...
// SmcExchangeFromKFIVEIterator is returned from FilterExchangeFromKFIVE and is used to iterate over the raw logs and unpacked data for ExchangeFromKFIVE events raised by the Smc contract.
type SmcExchangeFromKFIVEIterator struct {
	Event *SmcExchangeFromKFIVE // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SmcExchangeFromKFIVEIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SmcExchangeFromKFIVE)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SmcExchangeFromKFIVEIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SmcExchangeFromKFIVEIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SmcExchangeFromKFIVE represents a ExchangeFromKFIVE event raised by the Smc contract.
type SmcExchangeFromKFIVE struct {
	User  common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}
...
func (_Smc *SmcFilterer) FilterExchangeFromKFIVE(opts *bind.FilterOpts) (*SmcExchangeFromKFIVEIterator, error) {

	logs, sub, err := _Smc.contract.FilterLogs(opts, "ExchangeFromKFIVE")
	if err != nil {
		return nil, err
	}
	return &SmcExchangeFromKFIVEIterator{contract: _Smc.contract, event: "ExchangeFromKFIVE", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ExchangeFromKFIVE(address user, uint256 value)
func (_Smc *SmcFilterer) WatchExchangeFromKFIVE(opts *bind.WatchOpts, sink chan<- *SmcExchangeFromKFIVE) (event.Subscription, error) {

	logs, sub, err := _Smc.contract.WatchLogs(opts, "ExchangeFromKFIVE")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SmcExchangeFromKFIVE)
				if err := _Smc.contract.UnpackLog(event, "ExchangeFromKFIVE", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ExchangeFromKFIVE(address user, uint256 value)
func (_Smc *SmcFilterer) ParseExchangeFromKFIVE(log types.Log) (*SmcExchangeFromKFIVE, error) {
	event := new(SmcExchangeFromKFIVE)
	if err := _Smc.contract.UnpackLog(event, "ExchangeFromKFIVE", log); err != nil {
		return nil, err
	}
...
// SmcKfiveAddressChangedIterator is returned from FilterKfiveAddressChanged and is used to iterate over the raw logs and unpacked data for KfiveAddressChanged events raised by the Smc contract.
type SmcKfiveAddressChangedIterator struct {
	Event *SmcKfiveAddressChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SmcKfiveAddressChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SmcKfiveAddressChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SmcKfiveAddressChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SmcKfiveAddressChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SmcKfiveAddressChanged represents a KfiveAddressChanged event raised by the Smc contract.
type SmcKfiveAddressChanged struct {
...
func (_Smc *SmcFilterer) FilterKfiveAddressChanged(opts *bind.FilterOpts) (*SmcKfiveAddressChangedIterator, error) {

	logs, sub, err := _Smc.contract.FilterLogs(opts, "KfiveAddressChanged")
	if err != nil {
		return nil, err
	}
	return &SmcKfiveAddressChangedIterator{contract: _Smc.contract, event: "KfiveAddressChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event KfiveAddressChanged(address kfiveAddress)
func (_Smc *SmcFilterer) WatchKfiveAddressChanged(opts *bind.WatchOpts, sink chan<- *SmcKfiveAddressChanged) (event.Subscription, error) {

	logs, sub, err := _Smc.contract.WatchLogs(opts, "KfiveAddressChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SmcKfiveAddressChanged)
				if err := _Smc.contract.UnpackLog(event, "KfiveAddressChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event KfiveAddressChanged(address kfiveAddress)
func (_Smc *SmcFilterer) ParseKfiveAddressChanged(log types.Log) (*SmcKfiveAddressChanged, error) {
	event := new(SmcKfiveAddressChanged)
	if err := _Smc.contract.UnpackLog(event, "KfiveAddressChanged", log); err != nil {
		return nil, err
	}
...
// SmcKfiveReceiverTransferredIterator is returned from FilterKfiveReceiverTransferred and is used to iterate over the raw logs and unpacked data for KfiveReceiverTransferred events raised by the Smc contract.
type SmcKfiveReceiverTransferredIterator struct {
	Event *SmcKfiveReceiverTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SmcKfiveReceiverTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SmcKfiveReceiverTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SmcKfiveReceiverTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SmcKfiveReceiverTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SmcKfiveReceiverTransferred represents a KfiveReceiverTransferred event raised by the Smc contract.
type SmcKfiveReceiverTransferred struct {
...
func (_Smc *SmcFilterer) FilterKfiveReceiverTransferred(opts *bind.FilterOpts) (*SmcKfiveReceiverTransferredIterator, error) {

	logs, sub, err := _Smc.contract.FilterLogs(opts, "KfiveReceiverTransferred")
	if err != nil {
		return nil, err
	}
	return &SmcKfiveReceiverTransferredIterator{contract: _Smc.contract, event: "KfiveReceiverTransferred", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event KfiveReceiverTransferred(address oldReceiver, address newReceiver)
func (_Smc *SmcFilterer) WatchKfiveReceiverTransferred(opts *bind.WatchOpts, sink chan<- *SmcKfiveReceiverTransferred) (event.Subscription, error) {

	logs, sub, err := _Smc.contract.WatchLogs(opts, "KfiveReceiverTransferred")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SmcKfiveReceiverTransferred)
				if err := _Smc.contract.UnpackLog(event, "KfiveReceiverTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event KfiveReceiverTransferred(address oldReceiver, address newReceiver)
func (_Smc *SmcFilterer) ParseKfiveReceiverTransferred(log types.Log) (*SmcKfiveReceiverTransferred, error) {
	event := new(SmcKfiveReceiverTransferred)
	if err := _Smc.contract.UnpackLog(event, "KfiveReceiverTransferred", log); err != nil {
		return nil, err
	}
