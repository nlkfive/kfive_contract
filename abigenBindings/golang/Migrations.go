...
func (_Smc *SmcCaller) LastCompletedMigration(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "last_completed_migration")
...
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_Smc *SmcSession) LastCompletedMigration() (*big.Int, error) {
	return _Smc.Contract.LastCompletedMigration(&_Smc.CallOpts)
}

// LastCompletedMigration is a free data retrieval call binding the contract method 0x445df0ac.
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_Smc *SmcCallerSession) LastCompletedMigration() (*big.Int, error) {
	return _Smc.Contract.LastCompletedMigration(&_Smc.CallOpts)
}
...
func (_Smc *SmcTransactor) SetCompleted(opts *bind.TransactOpts, completed *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "setCompleted", completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_Smc *SmcSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.SetCompleted(&_Smc.TransactOpts, completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_Smc *SmcTransactorSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.SetCompleted(&_Smc.TransactOpts, completed)
}
