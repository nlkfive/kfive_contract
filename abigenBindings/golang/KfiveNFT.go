...
func (_Smc *SmcCaller) MINTERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "MINTER_ROLE")
...
//
// Solidity: function MINTER_ROLE() view returns(bytes32)
func (_Smc *SmcSession) MINTERROLE() ([32]byte, error) {
	return _Smc.Contract.MINTERROLE(&_Smc.CallOpts)
}

// MINTERROLE is a free data retrieval call binding the contract method 0xd5391393.
//
// Solidity: function MINTER_ROLE() view returns(bytes32)
func (_Smc *SmcCallerSession) MINTERROLE() ([32]byte, error) {
	return _Smc.Contract.MINTERROLE(&_Smc.CallOpts)
}
...
func (_Smc *SmcCaller) TokenByIndex(opts *bind.CallOpts, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "tokenByIndex", index)
...
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Smc *SmcSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Smc.Contract.TokenByIndex(&_Smc.CallOpts, index)
}

// TokenByIndex is a free data retrieval call binding the contract method 0x4f6ccce7.
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Smc *SmcCallerSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Smc.Contract.TokenByIndex(&_Smc.CallOpts, index)
}
...
func (_Smc *SmcCaller) TokenOfOwnerByIndex(opts *bind.CallOpts, owner common.Address, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "tokenOfOwnerByIndex", owner, index)
...
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Smc *SmcSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Smc.Contract.TokenOfOwnerByIndex(&_Smc.CallOpts, owner, index)
}

// TokenOfOwnerByIndex is a free data retrieval call binding the contract method 0x2f745c59.
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Smc *SmcCallerSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Smc.Contract.TokenOfOwnerByIndex(&_Smc.CallOpts, owner, index)
}
...
func (_Smc *SmcTransactor) Burn(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "burn", tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Smc *SmcSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Burn(&_Smc.TransactOpts, tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Smc *SmcTransactorSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Smc.Contract.Burn(&_Smc.TransactOpts, tokenId)
}
...
func (_Smc *SmcTransactor) Mint(opts *bind.TransactOpts, to common.Address, tokenId *big.Int, gtokenURI string) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "mint", to, tokenId, gtokenURI)
}

// Mint is a paid mutator transaction binding the contract method 0xd3fc9864.
//
// Solidity: function mint(address to, uint256 tokenId, string gtokenURI) returns()
func (_Smc *SmcSession) Mint(to common.Address, tokenId *big.Int, gtokenURI string) (*types.Transaction, error) {
	return _Smc.Contract.Mint(&_Smc.TransactOpts, to, tokenId, gtokenURI)
}

// Mint is a paid mutator transaction binding the contract method 0xd3fc9864.
//
// Solidity: function mint(address to, uint256 tokenId, string gtokenURI) returns()
func (_Smc *SmcTransactorSession) Mint(to common.Address, tokenId *big.Int, gtokenURI string) (*types.Transaction, error) {
	return _Smc.Contract.Mint(&_Smc.TransactOpts, to, tokenId, gtokenURI)
}
