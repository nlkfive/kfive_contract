...
func (_Smc *SmcCaller) Allowance(opts *bind.CallOpts, _owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "allowance", _owner, spender)
...
//
// Solidity: function allowance(address _owner, address spender) view returns(uint256)
func (_Smc *SmcSession) Allowance(_owner common.Address, spender common.Address) (*big.Int, error) {
	return _Smc.Contract.Allowance(&_Smc.CallOpts, _owner, spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address _owner, address spender) view returns(uint256)
func (_Smc *SmcCallerSession) Allowance(_owner common.Address, spender common.Address) (*big.Int, error) {
	return _Smc.Contract.Allowance(&_Smc.CallOpts, _owner, spender)
}
