...
var BlindAuctionStorageMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// BlindAuctionStorageBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use BlindAuctionStorageMetaData.Bin instead.
var BlindAuctionStorageBin = BlindAuctionStorageMetaData.Bin

// DeployBlindAuctionStorage deploys a new Ethereum contract, binding an instance of BlindAuctionStorage to it.
func DeployBlindAuctionStorage(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *BlindAuctionStorage, error) {
	parsed, err := BlindAuctionStorageMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(BlindAuctionStorageBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &BlindAuctionStorage{BlindAuctionStorageCaller: BlindAuctionStorageCaller{contract: contract}, BlindAuctionStorageTransactor: BlindAuctionStorageTransactor{contract: contract}, BlindAuctionStorageFilterer: BlindAuctionStorageFilterer{contract: contract}}, nil
}
