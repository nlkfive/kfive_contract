...
func (_Smc *SmcCaller) DomainSeparator(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "domainSeparator")
...
//
// Solidity: function domainSeparator() view returns(bytes32)
func (_Smc *SmcSession) DomainSeparator() ([32]byte, error) {
	return _Smc.Contract.DomainSeparator(&_Smc.CallOpts)
}

// DomainSeparator is a free data retrieval call binding the contract method 0xf698da25.
//
// Solidity: function domainSeparator() view returns(bytes32)
func (_Smc *SmcCallerSession) DomainSeparator() ([32]byte, error) {
	return _Smc.Contract.DomainSeparator(&_Smc.CallOpts)
}
...
func (_Smc *SmcCaller) GetChainId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "getChainId")
...
//
// Solidity: function getChainId() view returns(uint256)
func (_Smc *SmcSession) GetChainId() (*big.Int, error) {
	return _Smc.Contract.GetChainId(&_Smc.CallOpts)
}

// GetChainId is a free data retrieval call binding the contract method 0x3408e470.
//
// Solidity: function getChainId() view returns(uint256)
func (_Smc *SmcCallerSession) GetChainId() (*big.Int, error) {
	return _Smc.Contract.GetChainId(&_Smc.CallOpts)
}
...
func (_Smc *SmcCaller) GetNonce(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Smc.contract.Call(opts, &out, "getNonce", user)
...
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Smc *SmcSession) GetNonce(user common.Address) (*big.Int, error) {
	return _Smc.Contract.GetNonce(&_Smc.CallOpts, user)
}

// GetNonce is a free data retrieval call binding the contract method 0x2d0335ab.
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Smc *SmcCallerSession) GetNonce(user common.Address) (*big.Int, error) {
	return _Smc.Contract.GetNonce(&_Smc.CallOpts, user)
}
...
func (_Smc *SmcTransactor) ExecuteMetaTransaction(opts *bind.TransactOpts, userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Smc.contract.Transact(opts, "executeMetaTransaction", userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Smc *SmcSession) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Smc.Contract.ExecuteMetaTransaction(&_Smc.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Smc *SmcTransactorSession) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Smc.Contract.ExecuteMetaTransaction(&_Smc.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}

// SmcMetaTransactionExecutedIterator is returned from FilterMetaTransactionExecuted and is used to iterate over the raw logs and unpacked data for MetaTransactionExecuted events raised by the Smc contract.
type SmcMetaTransactionExecutedIterator struct {
	Event *SmcMetaTransactionExecuted // Event containing the contract specifics and raw log
...
func (it *SmcMetaTransactionExecutedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SmcMetaTransactionExecuted)
...
func (it *SmcMetaTransactionExecutedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SmcMetaTransactionExecutedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SmcMetaTransactionExecuted represents a MetaTransactionExecuted event raised by the Smc contract.
type SmcMetaTransactionExecuted struct {
...
func (_Smc *SmcFilterer) FilterMetaTransactionExecuted(opts *bind.FilterOpts) (*SmcMetaTransactionExecutedIterator, error) {

	logs, sub, err := _Smc.contract.FilterLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return &SmcMetaTransactionExecutedIterator{contract: _Smc.contract, event: "MetaTransactionExecuted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Smc *SmcFilterer) WatchMetaTransactionExecuted(opts *bind.WatchOpts, sink chan<- *SmcMetaTransactionExecuted) (event.Subscription, error) {

	logs, sub, err := _Smc.contract.WatchLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(SmcMetaTransactionExecuted)
				if err := _Smc.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Smc *SmcFilterer) ParseMetaTransactionExecuted(log types.Log) (*SmcMetaTransactionExecuted, error) {
	event := new(SmcMetaTransactionExecuted)
	if err := _Smc.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
		return nil, err
	}
