...
contract("Auction Marketplace", (accounts) => {
    ...
    describe('AUCTION 5: Two accounts bid the same bidValue and deposit', async () => {
        ...
        it('(Account2) Bid: 4 KFIVE; Deposit: 5 KFIVE; Fake: false. VALID BID', async () => {
            const i = {
        ...
        it('(Account5) Bid: 4 KFIVE; Deposit: 5 KFIVE; Fake: false. VALID BID', async () => {
            const i = {
                bidValue: 4 * (10 ** tokenDecimals),
                fake: false,
                secret: web3.utils.fromAscii("1234"),
        ...
        it('BEFORE REVEAL Auction 5: Check balance of account2, account5 and auctionMarketplace', async () => {
            const o = {
                ...
                kfive_market_balance_before_reveal: 10 * (10 ** tokenDecimals),
            }
        ...
        it('(Account5) reveal bid. Market refund', async () => {
            const i = {
                nftAddress: nlgst.address,
                nftID: 5,
                auctionID: auctionId,
        ...
        it('AuctionEnd. Account1 call acutionEnd', async () => {
            await auctionMarketplace.auctionEnd(nlgst.address, 5, auctionId, { from: account1 });
        });
