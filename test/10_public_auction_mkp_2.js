...
contract("Public Auction Marketplace", (accounts) => {
    ...
    describe('AUCTION 2: Simple public auction marketplace', async () => {
        ...
        it('(Account2) Bid: 1 KFIVE. Cannot, before startTime', async () => {
            const i = {
        ...
        it('(Account2) Bid: 1 KFIVE. Cannot because bidValue == startPrice', async () => {
            const i = {
                bidValue: 1 * (10 ** tokenDecimals)
            }
        ...
        it('(Account5) Bid: 2 KFIVE. Cannot, lower than account2', async () => {
            const i = {
        ...
        it('(Account6) Bid: 6 KFIVE. Cannot, bidding stage ended', async () => {
            const i = {
            ...
            let account6_balance = await kfive.balanceOf(account6, { from: root });
            eq(10 * (10 ** tokenDecimals), account6_balance.toString());
        });

        it('(Account1) Cancel Auction. Cannot, over biddingEnd', async () => {
