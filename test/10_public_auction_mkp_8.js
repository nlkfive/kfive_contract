...
contract("Public Auction Marketplace", (accounts) => {
    ...
    describe('PUBLIC AUCTION 8: Scenario' + '\n' +
             '          + Account1 create Public Auction' + '\n' +
             '          + Account2 bid 3 KFIVE' + '\n' +
             '          + Root update new Storage address' + '\n' +
             '          + Account5 cannot bid 4 KFIVE' + '\n' +
             '          + Root update old Storage address' + '\n' +
             '          + Account5 bid 4 KFIVE' + '\n' +
             '          + Set new beneficary' + '\n' +
             '          + Bid End. Account5 receive reward, new beneicary receive ownercut amount', async () => {
        var auctionId;
