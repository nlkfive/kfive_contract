...
contract("Public Auction Marketplace", (accounts) => {
    ...
    describe('AUCTION 4: Simple public auction marketplace', async () => {
        ...
        it('(Account2) Pause Auction Marketplace. Cannot, only PAUSER_ROLE', async () => {
        ...
        it('(Pauser) Pause Auction Marketplace', async () => {
        ...
        it('(Account1) Create new auction NFT(1). Cannot, contract is pausing', async () => {
            const i = {
                nftID: 1,
        ...
        it('(Root) Pause Auction Marketplace', async () => {
            await auctionMarketplace.pause({
                from: root
            });
        ...
        it('(Account2) Bid: 3 KFIVE. Cannot, pausing', async () => {
            const i = {
        ...
        it('(Root) UnPause Auction Marketplace', async () => {
            await auctionMarketplace.unpause({
                from: root
            });
        ...
        it('(Account5) Receive reward. Cannot, auction is pausing', async () => {
            await u.assertRevert(auctionMarketplace.receiveReward(nlgst.address, auctionId, nftAsset, 1, {
                from: account5
            }));
        });

        it('(Pauser) UnPause Auction Marketplace', async () => {
            await auctionMarketplace.unpause({
                from: root
            });
