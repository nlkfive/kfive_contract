    ...
    IRegistrationList
{
    ...
    mapping(bytes32 => mapping(uint256 => address)) public participants;
    // From raceId => (slotId => (index => participant address))
    mapping(bytes32 => mapping(uint256 => mapping(uint8 => address))) public registrationList;
    ...
    mapping(bytes32 => bytes32) public randomSelected;
    ...
    mapping(bytes32 => bytes32) public totalRegistered;
    // From vrf request id to running raceId
    mapping(bytes32 => bytes32) public vrfRandomMap;
